...
describe("receiptImage pure helpers", () => {
  ...
  it("has localized scan-to-verify caption text", () => {
    assert.equal(translations.en.receipt.scanToVerify, "Scan to verify");
    assert.equal(translations.id.receipt.scanToVerify, "Scan untuk verifikasi");
  });
});
